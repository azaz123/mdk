...
//    public static final byte MYCAT_SHOW_CONFIGS = 44;
    ...
    public static final byte ANNOTATION_CUSTOM = 11;
    ...
    private int annotationStart = 0;
    private int annotationLength = 0;
...
//        }
    ...
    public void setWholeAnnotation(int start, int length) {
    	annotationStart = start;
    	annotationLength = length;
    }
    
    public String getWholeAnnotation() {
        return buffer.getString(annotationStart, annotationLength);
    }
}
