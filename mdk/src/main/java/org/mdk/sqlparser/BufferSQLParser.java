...
import static org.mdk.sqlparser.byteArrayInterface.TokenizerUtil.debug;

import java.nio.ByteBuffer;


import org.mdk.sqlparser.SQLParseUtils.HashArray;
import org.mdk.sqlparser.byteArrayInterface.ByteArrayInterface;
import org.mdk.sqlparser.byteArrayInterface.ByteBufferArray;
import org.mdk.sqlparser.byteArrayInterface.DefaultByteArray;
import org.mdk.sqlparser.byteArrayInterface.SelectItemsParser;
import org.mdk.sqlparser.byteArrayInterface.Tokenizer2;
import org.mdk.sqlparser.byteArrayInterface.TokenizerUtil;
import org.mdk.sqlparser.byteArrayInterface.dcl.DCLSQLParser;
...
public class BufferSQLParser {
    ...
    int pickWholeAnnotation(int pos, final int arrayCount, BufferSQLContext context) {
        int intHash;
            ...
            if (hashArray.getType(pos++) == Tokenizer2.EQUAL) {
                ...
                context.setWholeAnnotation(start, length);
                context.setAnnotationStringValue(BufferSQLContext.ANNOTATION_CUSTOM, context.getWholeAnnotation());
                context.setAnnotationType(BufferSQLContext.ANNOTATION_CUSTOM);
                pos++;
            }
        ...
        while (pos < arrayCount) {
            switch (hashArray.getIntHash(pos)) {
                ...
                case IntTokenHash.ANNOTATION_START:
                	...
                	pos = pickWholeAnnotation(++pos, arrayCount, context);
                    break;
